...
// DrawClient.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CDrawClientApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDrawClientApp::OnAppAbout)
END_MESSAGE_MAP()


// construction CDrawClientApp

CDrawClientApp::CDrawClientApp()
{
...
// Seul et unique objet CDrawClientApp

CDrawClientApp theApp;
Gdiplus::GdiplusStartupInput gdiplusStartupInput;
ULONG_PTR gdiplusToken;
// initialisation de CDrawClientApp

BOOL CDrawClientApp::InitInstance()
{
...
int CDrawClientApp::ExitInstance( ){
	Gdiplus::GdiplusShutdown(gdiplusToken);
	return 0;
}
// gestionnaires de messages pour CDrawClientApp
...
void CDrawClientApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
